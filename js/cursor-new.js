...
! function(t) {
        ...
        switch (u) {
            ...
            case E.STYLE_SIZE:
                var s = a(t, y.WIDTH),
                    ...
                    d = void 0,
                    p = void 0;
                return d = c.widthUnit === y.AUTO ? x.test(s) ? parseFloat(s) : parseFloat(n.width) : (0, f.default)(parseFloat(s), parseFloat(n.width)), p = c.heightUnit === y.AUTO ? x.test(l) ? parseFloat(l) : parseFloat(n.height) : (0, f.default)(parseFloat(l), parseFloat(n.height)), {
                    widthValue: d,
                    heightValue: p
                };
            case E.STYLE_BACKGROUND_COLOR:
    ...
    function L(t) {
        ...
        var L = (0, s.default)(n, "action.config.affectedElements", {})[m || O] || {},
            x = Boolean(L.id || L.selector),
            N = void 0,
            C = void 0,
            M = void 0,
            P = n && u(R(n.target));
        if (x ? (N = L.limitAffectedElements, C = P, M = u(L)) : C = M = u({
                id: m,
                selector: O,
                selectorGuids: T
            }), n && A) {
    ...
    t.exports = function(t, e, n, v, h, E, _) {
        ...
        if (L && (m = f(L.call(new t))) !== Object.prototype && m.next && (s(m, O, !0), r || "function" == typeof m[l] || a(m, l, p)), T && A && "values" !== A.name && (b = !0, w = function() {
                return A.call(this)
    ...
    }, e.startEngine = D, e.stopEngine = j, e.stopAllActionGroups = B, e.stopActionGroup = H, e.startActionGroup = W;
    var c = A(n(124)),
        s = A(n(36)),
        f = A(n(279)),
        l = A(n(285)),
                ...
                r ? function(t) {
                    ...
                    if ((0, f.default)(d)) {
                        (0, v.default)(d, function(t, e) {
                            ...
                            }(a.actionTypeId === b.GENERAL_START_ACTION || N(a.actionTypeId)) && X({
                                store: n,
                                actionListId: f,
                                eventId: u
                            })
    ...
    function q(t, e) {
        ...
        if ((0, y.shouldAllowMediaQuery)(w, S.mediaQueryKey) && (r || n || i)) {
            if (s || c === T.RENDER_GENERAL && i) {
                ...
                switch (x) {
                    case T.HTML_ELEMENT:
                        (0, y.renderHTMLElement)(L, N, C, l, a, E, O, c, g)
                }
            }
            if (i) {
                if (h) {
    ...
    n(133), n(160), n(161), n(330), n(331), t.exports = n(332)
}, function(t, e, n) {
    "use strict";
    var r = n(13);
    ...
    var r = n(4),
        ...
        z = function(t, e, n) {
            return t === k && z(V, e, n), y(t), e = I(e, !0), y(n), i(G, e) ? (n.enumerable ? (i(t, P) && t[P][e] && (t[P][e] = !1), n = T(n, {
                enumerable: O(0, !1)
            })) : (i(t, P) || L(t, P, O(1, {})), t[P][e] = !0), H(t, e, n)) : L(t, e, n)
        },
        K = function(t, e) {
            y(t);
        ...
        $ = function(t) {
            for (var e, n = x(m(t)), r = [], o = 0; n.length > o;) i(G, e = n[o++]) || e == P || e == c || r.push(e);
            return r
        },
        Z = function(t) {
            for (var e, n = t === k, r = x(n ? V : m(t)), o = [], a = 0; r.length > a;) !i(G, e = r[a++]) || n && !i(k, e) || o.push(G[e]);
            return o
        };
    U || (u((N = function() {
        ...
        c = function(t, e) {
            ...
            for (var m = void 0, I = void 0, O = void 0, T = void 0, b = 0, S = i.length; b < S; b++) {
                ...
                if (0 === b && (m = R[0]), g >= w) {
                    ...
                    var L = i[b + 1],
                        x = L && g !== w;
                    I = x ? L.actionItems[0] : null, x && (O = w / 100, T = (L.keyframe - w) / 100)
                }
            }
            var N = {};
            if (m && !I)
                for (var C = 0, M = c.length; C < M; C++) {
                    ...
                    for (var D = (y - O) / T, j = m.config.easing, F = (0, a.applyEasing)(j, D), G = 0, V = c.length; G < V; G++) {
                        var k = c[G],
                            U = (0, u.getItemConfigByKey)(l, k, m.config, d, y),
                            X = ((0, u.getItemConfigByKey)(l, k, I.config, d, y) - U) * F + U;
                        N[k] = X
                    }
            return (0, o.merge)(t, {
                position: y,
        ...
        switch (e.type) {
            ...
            case i.IX2_INSTANCE_ADDED:
                var n = e.payload,
                    ...
                    L = (0, u.getStyleProp)(R, w),
                    x = Object.keys(y).filter(function(t) {
                        return null != y[t]
                    });
                return (0, o.set)(t, r, {
                    id: r,
            ...
            case i.IX2_ANIMATION_FRAME_CHANGED:
                for (var G = t, V = Object.keys(t), k = V.length, U = 0; U < k; U++) {
                    var X = V[U],
                        B = t[X],
                        H = B.continuous ? c : s;
                    G = (0, o.set)(G, X, H(B, e))
    ...
    e.default = (r = {}, (0, i.default)(r, v.SLIDER_ACTIVE, F()), (0, i.default)(r, v.SLIDER_INACTIVE, G()), (0, i.default)(r, v.DROPDOWN_OPEN, F()), (0, i.default)(r, v.DROPDOWN_CLOSE, G()), (0, i.default)(r, v.NAVBAR_OPEN, F(!1)), (0, i.default)(r, v.NAVBAR_CLOSE, G(!1)), (0, i.default)(r, v.TAB_ACTIVE, F()), (0, i.default)(r, v.TAB_INACTIVE, G()), (0, i.default)(r, v.ECOMMERCE_CART_OPEN, {
        ...
        handler: function(t) {
            ...
            return A && (w > .95 || w < .05) && (w = Math.round(w)), (u !== v.ELEMENT || L || L !== a.elementHovered) && (w = f ? 1 - w : w, e.dispatch((0, p.parameterChanged)(R, w))), {
                elementHovered: L,
                clientX: _,
                clientY: g,
                pageX: I,
        ...
        handler: function(t) {
            ...
            var R = (0, d.getNamespacedParameterId)(i, _),
                ...
                N = (m ? S : 0) / 100;
            x = y ? x : 1 - x, N = g ? N : 1 - N;
            var M = L.top + Math.min(L.height * x, l),
                P = L.top + L.height * N - M,
                D = Math.min(l + P, f),
    ...
    }), (0, i.default)(r, v.SCROLL_INTO_VIEW, V), (0, i.default)(r, v.SCROLL_OUT_OF_VIEW, V), (0, i.default)(r, v.PAGE_SCROLL_DOWN, (0, u.default)({}, x, {
        handler: D(function(t, e) {
            e.scrollingDown && S(t)
        })
    })), (0, i.default)(r, v.PAGE_SCROLL_UP, (0, u.default)({}, x, {
        handler: D(function(t, e) {
            e.scrollingDown || S(t)
        })
...
Webflow.require('ix2').init({
    "events": {
        ...
        "e-3": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": "a, .swiper-button-next, .swiper-button-prev",
                "originalId": "5c5360f7dfcb96a862d89130|635184ee-71d1-9f2e-4a53-a29f19c36384",
                "appliesTo": "CLASS"
            },
            "config": {
                "loop": false,
    ...
    "actionLists": {
        "a": {
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".cursor-dot",
                                "selectorGuids": ["380d271a-756a-56c5-e228-e4d581699ca7"]
                            },
                            "xValue": -50,
                            "xUnit": "VW",
                            "yUnit": "PX",
            ...
            "createdOn": 1548972499480
        },
        "a-2": {
            "id": "a-2",
            "title": "Cursor Follows (Circle)",
            "continuousParameterGroups": [{
                "id": "a-2-p",
                "type": "MOUSE_X",
                "parameterLabel": "Mouse X",
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selectorGuids": ["fde12876-dca5-5a05-9ecd-378720b1a6d8"]
                            },
                            "xValue": -50,
                            "xUnit": "VW",
                            "yUnit": "PX",
        ...
        "a-3": {
            ...
            "createdOn": 1548976653888,
            "useFirstGroupAsInitialState": false
        },
        "a-4": {
            "id": "a-4",
            "title": "Links Hover Out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-4-n-2",
                    "actionTypeId": "STYLE_OPACITY",
